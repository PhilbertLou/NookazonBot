...
import re, time
#DO MORE TESTING ON SPEEDS WITH/WITHOUT DELAY (WITHOUT DELAY OPTIMAL, MAKE SURE IT RUNS CORRECTLY WITHOUT IT)
...
while True:
    ...
    #IF PAYING IN BELLS
        ...
        for listing in range(bidNum):
            ...
            try:
                if word == 'Make an Offer' and currencyType != 'Nook Miles Ticket':
